...
#include "../../Cashlab/Program/Semiology_20150120/Controller/MainWindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UI__MainWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 76, 25),
QT_MOC_LITERAL(7, 102, 5),
QT_MOC_LITERAL(8, 108, 26),
QT_MOC_LITERAL(9, 135, 19),
QT_MOC_LITERAL(10, 155, 17)
    },
    "UI::MainWindow\0ActionOpenTriggered\0\0"
    "ActionColormapTriggered\0QAction*\0"
    "action\0ActionShowColormapToggled\0state\0"
    "ActionHemispheresTriggered\0"
    "ActionCycleViewMode\0ApplicationLoaded"
};
...
void UI::MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->ActionOpenTriggered(); break;
        case 1: _t->ActionColormapTriggered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 2: _t->ActionShowColormapToggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->ActionHemispheresTriggered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 4: _t->ActionCycleViewMode(); break;
        case 5: _t->ApplicationLoaded(); break;
        default: ;
        }
    }
}
